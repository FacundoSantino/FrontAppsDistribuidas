...
type PasosRouteProps= RouteProp<TipoParametros, "PasosLocal">;
import VideoPlayer from 'react-native-video-controls';


export default function PasosLocal(props:PasosRouteProps): JSX.Element{
    ...
    const fetchPasos = async () => {
        try{
            setListaPasos(route.params.pasos);
            setPasoActual(route.params.pasos[0]);
            setLoaded(true);
        }
        catch(error){
